...
class TestProactiveAssistant:
    """Test suite for ProactiveAssistant."""
    ...
    def test_get_proactive_suggestions_no_context(self, assistant):
        """Test proactive suggestion generation without context."""
    ...
    def test_get_proactive_suggestions_no_preferences(self, assistant, sample_context):
        """Test proactive suggestion generation without preferences."""
    ...
    def test_get_proactive_suggestions_early_conversation(self, assistant):
        """Test proactive suggestions for early conversation."""
        context = {
            "stage": "exploring",
            "message_count": 2,
    ...
    def test_get_proactive_suggestions_planning_stage(self, assistant, sample_preferences):
        """Test proactive suggestions for planning stage."""
        context = {
            "stage": "planning",
            "message_count": 8,
    ...
    def test_get_proactive_suggestions_finalizing_stage(self, assistant, sample_preferences):
        """Test proactive suggestions for finalizing stage."""
        context = {
            "stage": "finalizing",
            "message_count": 15,
    ...
    def test_calculate_days_until_travel_past_dates(self, assistant):
        """Test days until travel calculation with past dates."""
    ...
    def test_anticipate_next_questions_exploring(self, assistant):
        """Test next question anticipation for exploring stage."""
        stage = "exploring"
    ...
    def test_anticipate_next_questions_comparing(self, assistant):
        """Test next question anticipation for comparing stage."""
        stage = "comparing"
        preferences = {
    ...
    def test_anticipate_next_questions_planning(self, assistant):
        """Test next question anticipation for planning stage."""
        stage = "planning"
        preferences = {
            "destinations": ["Paris"],
            "budget_range": "moderate",
    ...
    def test_anticipate_next_questions_finalizing(self, assistant):
        """Test next question anticipation for finalizing stage."""
        stage = "finalizing"
        preferences = {
            "destinations": ["Paris"],
            "budget_range": "moderate",
    ...
    def test_anticipate_next_questions_no_preferences(self, assistant):
        """Test next question anticipation without preferences."""
        stage = "exploring"
        preferences = {}
        recent_topics = []
    ...
    def test_anticipate_next_questions_unknown_stage(self, assistant):
        """Test next question anticipation for unknown stage."""
        stage = "unknown_stage"
        preferences = {"destinations": ["Paris"]}
        recent_topics = ["destinations"]
    ...
    def test_generate_suggestions_no_conversation(self, assistant):
        """Test suggestion generation without conversation."""
    ...
    def test_proactive_suggestions_priority_ordering(self, assistant, sample_context, sample_preferences):
        """Test that proactive suggestions are properly prioritized."""
        suggestions = assistant.get_proactive_suggestions(sample_context, sample_preferences, 5)
        ...
        for suggestion in suggestions:
            ...
            assert suggestion['priority'] <= 10  # Assuming 0-10 scale
    
    def test_proactive_suggestions_type_categorization(self, assistant, sample_context, sample_preferences):
        """Test that proactive suggestions have proper type categorization."""
        suggestions = assistant.get_proactive_suggestions(sample_context, sample_preferences, 5)
    ...
    def test_proactive_suggestions_content_quality(self, assistant, sample_context, sample_preferences):
        """Test that proactive suggestions have quality content."""
        suggestions = assistant.get_proactive_suggestions(sample_context, sample_preferences, 5)
        ...
        for suggestion in suggestions:
            ...
            assert len(suggestion['content']) > 10  # Should be substantial
    ...
    def test_anticipate_next_questions_relevance(self, assistant):
        """Test that anticipated questions are relevant to the context."""
        stage = "planning"
        preferences = {
            "destinations": ["Paris"],
            "budget_range": "moderate",
    ...
    def test_proactive_suggestions_edge_cases(self, assistant):
        """Test proactive suggestions with edge cases."""
        # Very long context
        long_context = {
            "stage": "planning",
            "message_count": 100,
    ...
    def test_anticipate_next_questions_edge_cases(self, assistant):
        """Test next question anticipation with edge cases."""
    ...
    def test_proactive_suggestions_stage_specific(self, assistant):
        """Test that proactive suggestions are stage-specific."""
        # Test exploring stage
        exploring_context = {
            "stage": "exploring",
            "message_count": 2,
            "last_user_message": "I want to travel"
    ...
    def test_anticipate_next_questions_comprehensive(self, assistant):
        """Test comprehensive next question anticipation."""
        # Test all stages
        ...
        for stage in stages:
            ...
            assert len(questions) > 0
            assert all(isinstance(q, str) for q in questions)
            assert all(len(q) > 5 for q in questions)  # Questions should be substantial 