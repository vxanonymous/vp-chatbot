...
class ServiceContainer:
    ...
    def intelligence_service(self) -> VacationIntelligenceService:
        ...
        if self._intelligence_service is None:
            self._intelligence_service = VacationIntelligenceService(openai_service=self.openai_service)
    ...
    @property
    def request_deduplicator(self) -> RequestDeduplicator:
        # Get or create RequestDeduplicator instance.
        if self._request_deduplicator is None:
    ...
    def conversation_handler(self) -> ConversationHandler:
        ...
        if self._conversation_handler is None:
